...
@Data
public class MLoanRepaymentSchedule implements Serializable {
    ...
    private BigDecimal penaltyChargesAmount;
    @Basic(optional = false)
    @Column(name = "completed_derived")
    private boolean completedDerived;
    @JoinColumn(name = "loan_id", referencedColumnName = "id")
    @ManyToOne(optional = false)
    private MLoan loanId;
